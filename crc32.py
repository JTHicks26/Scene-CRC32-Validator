...
def main():
    ...
    while x < numFiles:                                             #For every .rXX file in the directory
        formattedFilename = unformattedFilename + ".r" + ("%0" + str(extLen) + "d") % x     #Append the proper extension for the current file to unformattedFilename
    ...
    correctCRC = read_correct_CRC32(unformattedFilename + '.rar').lower()   #Read correct checksum for the .rar file
    rarError = False
